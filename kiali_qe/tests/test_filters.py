...
FILTER_NAME = "test"
CONFIG_KEPT_FILTER = [
        {'name': ApplicationsPageFilter.NAMESPACE.text, 'value': FILTER_NAMESPACE}]
...
def test_workloads_filters_kept(kiali_client, openshift_client, browser):
    wr_filters = [
        {'name': WorkloadsPageFilter.NAMESPACE.text, 'value': FILTER_NAMESPACE},
...
def test_services_filters_kept(kiali_client, openshift_client, browser):
    services_filters = [
        {'name': ServicesPageFilter.NAMESPACE.text, 'value': FILTER_NAMESPACE},
...
def test_config_filters_kept(kiali_client, openshift_client, browser):
    config_filters = [
        {'name': IstioConfigPageFilter.NAMESPACE.text, 'value': FILTER_NAMESPACE},
