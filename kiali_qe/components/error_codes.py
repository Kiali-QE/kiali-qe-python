...
KIA0208 = 'PeerAuthentication enabling mTLS found, '\
...
KIA1103 = 'VirtualService doesn\'t define any valid route protocol'
...
KIA1104 = 'The weight is assumed to be '\
